  ...
  group('Tests showing class_switch library behaviour in edge cases.', () {
    test(
      ...
      String Function(NonAbstractBaseClass) func =
          NonAbstractBaseClassSwitcher.nonAbstractBaseClassSwitcher<String>(
              (firstSubType) {
        return "first";
      }, (secondSubType) {
        return "second";
    ...
    test(
      ...
      String Function(BaseClass) func =
          BaseClassSwitcher.baseClassSwitcher<String>((firstSubType) {
        return "first";
      }, (secondSubType) {
        return "second";
      });
    ...
    test(
        ...
        () {
      final function =
          ClassWithNoSubClassesSwitcher.classWithNoSubClassesSwitcher(
